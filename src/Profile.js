import React, {Component, gql} from "react";
...
class Profile extends Component {
    state = {
        selectedFile: null,
        photoUrl:
            this.this.props.session.me.photo ? this.this.props.session.me.photo : null,
        temporaryProfileHolder: null
    };

    query = gql`user(id: ${this.props.session.me.id}) {photo(options:"200, true, true, face")}`;
                ...
                <Query query={this.query}>
                    {({loading, error, data}) => {
                        ...
                        if (data.user.photo) {
                            ...
                            return <img
                                src="https://res.cloudinary.com/tamas-demo/image/upload/w_100,h_100,c_thumb,g_face,r_20/avatar.png"
                                alt=""/>
                        }
                    }}
                </Query>
                <p>Upload a profile photo: <input type="file" onChange={this.handleSelectedFile}/>
